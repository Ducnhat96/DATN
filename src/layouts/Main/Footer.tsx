            ...
            <Grid item xs={12} sm={4} md={4} className={classes.linksList}>
              ...
              <ul className={classes.linksListGroupList}>
                <p>
                  ...
                  <br />
                  <strong>Loại h&igrave;nh website: </strong>S&agrave;n giao
                  dịch TMĐT
                </p>{" "}
                <p>&nbsp;</p>{" "}
              </ul>
              ...
              <ul className={classes.linksListGroupList}>
                ...
                <li style={{ marginBottom: 8 }}>
                  ...
                  <a
                    ...
                    href="mailto:phamducnhat96@gmail.com"
                    target="_blank"
                  >
        ...
        <GridContainer xs={11}>
          <Grid container>
            <Grid item xs={12} sm={6} className={classes.rowFooter}>
              <Paper
                elevation={0}
                className={classNames(classes.paper, classes.textLeft)}
              >
...
export default compose<IProps, any>(withStyles(styles))(Footer);
