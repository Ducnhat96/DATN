...
interface IRoomRecentlyProps extends Required<WithStyles<typeof styles>> {
  room: RoomIndexRes
}
    ...
    <Fragment>
      <Grid container onClick={cardEvent} className={classes.root}>
        <Grid container item xs={12} spacing={8}>
          <Grid item xs={5}>
            <img src={`${IMAGE_STORAGE_XS}${room.media.data[0].image}`} alt='' className={classes.image} />
          </Grid>
...
export default compose<IRoomRecentlyProps, any>(
  withStyles(styles),
)(RoomRecently);
