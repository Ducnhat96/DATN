...
const RoomCardMap: ComponentType<IProps> = (props: IProps) => {
  ...
  const { room, isHover, focus } = props;
  ...
  const totalComfort =
    room.comforts.data.length < 25 ? room.comforts.data.length : 20;
      ...
      >
        <Grid container spacing={0}>
          <Grid item lg={4} sm={4} xs={12} className={classes.imgSize}>
            <Slider {...settings}>
              {roomMemo.media.data.length > 0 ? (
                _.map(roomMemo.media.data, o => (
                  <img
                    key={o.image}
                    ...
                    >
                        ...
                        <Grid container>
                          ...
                          <Grid item lg={12} sm={12} xs={12}>
                            ...
                            <span className={classes.verticalMid}>
                              ...
                              >{`${roomMemo.district.data.name}, ${roomMemo.city.data.name}`}</a>
                            </span>
                          </Grid>
                          <Hidden xsUp>
                            <Grid item lg={12} sm={12} style={{ marginTop: 6 }}>
                              <ul className={classes.ul}>
                                {_.map([1, 2, 3], val => (
                                  <li key={val} className={classes.list}>
                                    <SvgCustom />
                                  </li>
                                ))}
                                {totalComfort > 0 ? (
                      ...
                      >
                        <Grid container className={classes.price} spacing={0}>
                          <Grid container item xs={xsMode ? 12 : 9} spacing={2}>
                            <Grid item>
                              <Typography
                                variant={typoVariant}
...
export default compose<IProps, any>()(React.memo(RoomCardMap, memoCheck));
