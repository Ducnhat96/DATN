...
const InformationOfHomestay: ComponentType<IInformationOfHomestay> = (
  props: IInformationOfHomestay
) => {
          ...
          >
            <div className={classes.boxBook}>
              <Grid item xs={12} container direction="row">
                ...
                <Grid item xs={4}>
                  <div className={classes.benchmark}>9.9</div>
                </Grid>
              </Grid>
              <Grid item xs={12}>
                <div className={classes.collectionConvenient}>
                  <div className={classes.spanConvenient}>
                    <Flight className={classes.iconConvenient} />
                  </div>
                  <div className={classes.spanConvenient}>
                    <Restaurant className={classes.iconConvenient} />
                  </div>
                  <div className={classes.spanConvenient}>
                    <LocalFlorist className={classes.iconConvenient} />
                  </div>
                  <div className={classes.spanConvenientTotal}>
                    <span className={classes.spanTotal}>+18</span>
                  </div>
                </div>
              </Grid>
...
export default InformationOfHomestay;
