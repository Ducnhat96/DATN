...
const FormValidationSchema = Yup.object().shape({
  coupon: Yup.string().required("Vui lòng nhập mã giảm giá")
});
  ...
  return (
    <Formik
      ...
      onSubmit={(
        ...
        axios
          .post("coupons/calculate-discount", data)
              ...
              <Grid container spacing={1}>
                <Grid item xs={7}>
                  <FormControl
                    ...
                    fullWidth
                  >
                    <InputLabel htmlFor="coupon">Mã giảm giá</InputLabel>
                    <OutlineInput
                      id="coupon"
                      name="coupon"
                ...
                <Grid item xs={5}>
                  <Button
                    ...
                    variant="contained"
                  >
                    {isSubmitting ? <SimpleLoading /> : "Sử dụng"}
                  </Button>
                </Grid>
              </Grid>
            </Paper>
