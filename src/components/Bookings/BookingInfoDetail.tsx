...
const BookingInfoDetail: ComponentType<IProps> = props => {
  ...
  const { state, dispatch } = useContext<IBookingFormContext>(
    BookingFormContext
  );
        ...
        <Grid item xs={12}>
          <Paper className={classes.paperCustomOuter}>
                  ...
                  <Grid item xs={12}>
                    ...
                    <Grid container spacing={16} className={classes.spaceTop}>
                      ...
                      {!!coupon && discount != 0 ? (
                        ...
                        <Grid container item xs={12}>
                          <Grid item xs={12} className={classes.fontLowTitle}>
                            Mã giảm giá (<b>{coupon}</b>) không hợp lệ
                          </Grid>
                        </Grid>
                      ) : (
                        ""
                  ...
                  <Grid container item xs={12} justify="flex-end">
                    {price ? (
                      !state.coupon ? (
                        ...
                        <a href={"javascript:void"} onClick={removeCoupon}>
                          Gỡ mã giảm giá
                        </a>
                      )
                    ) : (
                    ...
                    >
                      {({ TransitionProps, placement }) => (
                        <ClickAwayListener
                          onClickAway={() => setCouponPanelStatus(false)}
                        >
                          <Grow
                            {...TransitionProps}
                            style={{
            ...
            {room && room!.settings ? (
              ...
              room!.settings.no_booking_cancel == 2 ? (
                <Grid item xs={12}>
...
export default compose<IProps, any>(withStyles(styles))(BookingInfoDetail);
